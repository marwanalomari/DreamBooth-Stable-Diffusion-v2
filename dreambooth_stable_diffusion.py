...
Original file is located at
    https://colab.research.google.com/drive/1KMDrhunMFPxZxBzexjKGdOvxEIV-TdhR
...
OUTPUT_DIR = "stable_diffusion_weights/person" #@param {type:"string"}
if save_to_gdrive:
...
concepts_list = [
    {
        ...
        "class_prompt":         "style",
        "instance_data_dir":    "/content/data/person",
...
!accelerate launch train_dreambooth.py \
  ...
  --max_train_steps=800 \
  --save_interval=10000 \
  --save_sample_prompt="person style man" \
...
prompt = "photo person" #@param {type:"string"}
